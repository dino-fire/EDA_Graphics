...
# Upper left
plot(y = subdat$Global_active_power, x = subdat$newtime, type = 's', main = '', xlab = '', ylab = 'Global Active Power')
...
# Upper right
plot(y = subdat$Voltage, x = subdat$newtime, type = 's', main = '', ylab = 'Voltage', xlab = 'datetime')

# Lower right
plot(y = subdat$Global_reactive_power, x = subdat$newtime, type = 's', main = '', ylab = 'Global_reactive_power', xlab = 'datetime')
